"""
Plot PRODEN / MCL-LOG / PiCO / PiCO-CLS accuracy vs k for C=20.

Data sources:
  PRODEN, MCL-LOG, PiCO  →  results/adam_comparison/gpu*/results.csv
  PiCO-CLS               →  results/pico_cls/results.csv

Usage:
    python scripts/plot_c20_comparison.py
    python scripts/plot_c20_comparison.py --out plots/c20_comparison/c20_comparison.png
"""
...
def main():
    ...
    parser.add_argument('--out',          default='plots/c20_comparison/c20_comparison.png')
